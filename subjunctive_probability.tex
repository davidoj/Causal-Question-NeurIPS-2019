...
\todo[inline]{Have I made any assumptions here besides additivity, }

To show that there are decision sets $D$ that are Polish spaces
...
\todo[inline]{I don't know that $D'$ has to be countable, the assumption that $D$ is standard Borel may be enough. I also don't understand the implications of the assumption of standard Borelness.}
