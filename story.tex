...
\cheng{This section requires the following descriptions in words (not precise enough here).
\begin{enumerate}
  \item What is decision problem / decision theory
  \item What is causal inference
  \item What is causal decision problem
  \item What is causal theory? The word relates is not precise enough.
  \item Clarify what are preferences? Only for causal decisions?
\end{enumerate}
}

\cheng{Specifically write a paragraph that starts with the following: ``The contributions of this paper are ... ''}
