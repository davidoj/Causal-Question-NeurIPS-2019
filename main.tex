...
While the general perspective offered here may often require the support of some method like graphical models to answer practical questions, it facilitates questions such as \emph{generically, what properties must a causal theory have in order to be ``learnable''?}, and such questions appear to be foundational to the development of causal theories that rely minimally on special purpose causal insights.
