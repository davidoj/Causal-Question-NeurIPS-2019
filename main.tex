...
\tikzset{
    ...
    expectation/.style = {triangle,draw,inner sep=0pt}}
...
\newcommand{\papertitle}{August 22: Exploring causal assumptions with string diagrams}
\title{\papertitle}
...
% \input{when_is_PO_CBN_same}
\input{stable_consequences}
