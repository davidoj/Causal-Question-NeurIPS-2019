...
\begin{example}[Disintegration]\label{ex:disintegration}
...
\begin{definition}[Random Variable Groups]
...
\begin{lemma}[$\utimes$ is associative]

\end{lemma}


\begin{example}[Disintegration - groups of variables]
